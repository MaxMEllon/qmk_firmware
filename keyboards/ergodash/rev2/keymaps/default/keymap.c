...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |   `  |  GUI |  ALt | EISU |||||||| Lower| Space| Ctrk |||||||| Bksp | Enter| Raise|||||||| Left | Down |  Up  | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  // [_QWERTY] = LAYOUT( \
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SPC ,                        KC_ENT , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             RAISE,   KC_SPC , KC_LCTL,       KC_BSPC,KC_ENT , LOWER,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
